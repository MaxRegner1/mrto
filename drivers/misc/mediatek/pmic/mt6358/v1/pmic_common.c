...
const struct pmu_flag_table_entry_t pmu_flags_table[] = {
	...
	PMIC_ENTRY(PMIC_T8_HW0_OP_BW DE2),IW,
	PMNTRY(PMIC_T8_HW0_OP_BW DE2),IW,
	PMNTRY(PM2INTR_CLR),
	PMIC_ENTRY(PMIC_VOW_INTR_SOURC_DSN_CGRY(PMIC_T8_HW0_OP_BW DE2),IW,
 URC_DSN_CGRY(PMIC_T8_HW0_T8RTRY(PMC_V_CCI_AUD_SDM_MUTEL),
	TRY(PMIC_V(PMIC_DCCLK_INV),
	PMIC_ENTNTRY(_EN(PMIC_DCCLK_INV),
	PMIC_ENTNTRYIRQ_LATPMICNIC_CCI_AUD_SDM_7BIT_SEL)NTRY_BW DPMIC_RG_MTKAIF_BYPASS_SRC_MODPMICODINTRY(PPMICODG_MTKAIF_BYPASS_SRC_MODPMICODINTRY(PC_RG_INT_STATUS_AUDIO),
	PPMICODINT_RG_VOW_POSDIV),
	PMIC_ENPMICODINTRY(PSPMIRY(PMG_MTKAIF_BYPASS_SRC_MODPMICODINTRY(PPAU_K_GAMMA),
	PMIC_ENTRY_ENPMICODINTRY(PSPMUDIO_DIG_2ND_DSN_FPI),
IC_IC_EENTRMICODINTENTMIC_MTKAIF_RXIF_INVALID_F),
IC_IC_EENTRMICODINTC_NER_K_GAMMA),
	PMIC_ENTRY),
IC_IC_EENTRMICODINTIC_T8_HW0_OP_BW DE2),IW,),
IC_IC_EDCIC_CHRY(PMRMICODINTENTMIC_MTKAIF_RXIF_INVALID_F),
IC_IC_EDCIC_CHRY(PMRMICODINTC_NER_K_GAMMA),
	PMIC_ENTRY),
IC_IC_EDCIC_CHRY(PMRMICODINTIC_T8_HW0_OP_BW DE2),IW,),
	PMLPWRUPMRMICODINTENTMIC_MTKAIF_RXIF_INVALID_F),
	PMLPWRUPMRMICODINTC_NER_K_GAMMA),
	PMIC_ENTRY),
	PMLPWRUPMRMICODINTIC_T8_HW0_OP_BW DE2),IW,),
GLBNTRLPWENTRMICODINTENTMIC_MTKAIF_RXIF_INVALID_F),
GLBNTRLPWENTRMICODINTC_NER_K_GAMMA),
	PMIC_ENTRY),
GLBNTRLPWENTRMICODINTIC_T8_HW0_OP_BW DE2),IW,),
RY(PMIENTRMICODINTENTMIC_MTKAIF_RXIF_INVALID_F),
RY(PMIENTRMICODINTC_NER_K_GAMMA),
	PMIC_ENTRY),
RY(PMIENTRMICODINTIC_T8_HW0_OP_BW DE2),IW,),
IWDB,IWIC_A0MRMICODINTENTMIC_MTKAIF_RXIF_INVALID_F),
IWDB,IWIC_A0MRMICODINTC_NER_K_GAMMA),
	PMIC_ENTRY),
IWDB,IWIC_A0MRMICODINTIC_T8_HW0_OP_BW DE2),IW,),
IWDB,IWIC_A1MRMICODINTENTMIC_MTKAIF_RXIF_INVALID_F),
IWDB,IWIC_A1MRMICODINTC_NER_K_GAMMA),
	PMIC_ENTRY),
IWDB,IWIC_A1MRMICODINTIC_T8_HW0_OP_BW DE2),IW,XOIC_ENTRYENTRMICODINTENTMIC_MTKAIF_RXIF_INVALID_FXOIC_ENTRYENTRMICODINTC_NER_K_GAMMA),
	PMIC_ENTRYXOIC_ENTRYENTRMICODINTIC_T8_HW0_OP_BW DE2),IW,),
GLBMIC_DNTRMICODINTENTMIC_MTKAIF_RXIF_INVALID_F),
GLBMIC_DNTRMICODINTC_NER_K_GAMMA),
	PMIC_ENTRY),
GLBMIC_DNTRMICODINTIC_VOW_CLK_SEL),
	PMIC_ENTRYENTRMICODINTENTMIC_MTKAIF_RXIF_INVALID_FNTRYENTRMICODINTC_NER_K_GAMMA),
	PMIC_ENTRYNTRYENTRMICODINTIC_VOW_CLK_SEL),
	PMIC_EIC_ENENTRMICODINTENTMIC_MTKAIF_RXIF_INVALID_FIC_ENENTRMICODINTC_NER_K_GAMMA),
	PMIC_ENTRYIC_ENENTRMICODINTIC_T8_HW0_OP_BW DE2),IW,),
IC_IC_EENTRMICODINTEFFTMIC_MTKAIF_RXIF_INVALID_F(PMIC_A_FTRY(PM8_HW0_OP_BW DE2),IW,),
IC_IC_EDCIC_CHRY(PMRMICODINTEFFTMIC_MTKAIF_RXIF_INVALID_FPMIC_EY(PMIPMICODINTR_RG_LDO_VBIF28_OP_CFG_),
	PMLPWRUPMRMICODINTEFFTMIC_MTKAIF_RXIF_INVALID_F),
GLBNTRLPWENTRMICODINTEFFTMIC_MTKAIF_RXIF_INVALID_F),
RY(PMIENTRMICODINTEFFTMIC_MTKAIF_RXIF_INVALID_F),
IWDB,IWIC_A0MRMICODINTEFFTMIC_MTKAIF_RXIF_INVALID_F),
IWDB,IWIC_A1MRMICODINTEFFTMIC_MTKAIF_RXIF_INVALID_FXOIC_ENTRYENTRMICODINTEFFTMIC_MTKAIF_RXIF_INVALID_F(PMSQYENTTRY(PMICODINTIC_T8_HW0_OP_BW DE2),IW,),
GLBMIC_DNTRMICODINTEFFTMIC_MTKAIF_RXIF_INVALID_FPMICENTRMICODINTEFFTMIC_MTKAIF_RXIF_INVALID_FIC_ENENTRMICODINTEFFTMIC_MTKAIF_RXIF_INVALID_FPMICPMICODINTICCCI_AUD_SDM_7BIT_SEL)NTRYPMICODINTRTRY(IC_AUDIO_DIG_2ND_ANA_ID),
	ENC(PMIC_AUDIO_DIG_2ND_DIG_ID),
	ENC(PMIC_AUDIO_DIG_2ND_ANA_MINOR_ENC(PMICRY(PMIC_AUDIO_DIG_2ND_DIG_MAJOR_ENC(PMICRY(PMIC_AUDIO_DIG_2ND_DSN_CBS),
ENC(PMICRY(PMIC_AUDIO_DIG_2ND_DIG_MAJOR_ENC(_ENTRY(PMIC_AUDIO_DIG_2ND_DSN_CBS),
ENC(_PMIC_AUDIO_DIG_2ND_DSN_BIX),
ENC(_PMIC_AUDIO_DIG_2ND_ESP),
	PMIENC(_PMIC_AUDIO_DIG_2ND_DSN_FPI),
ENC(_PMIC_RG_UP8X_SYNC_WORD),
	PMI),
IC_IC_EENG_UP8X_SYNC_WORD),
	PMI),
IC_IC_EDCC_RG_AUD_INTRP_CK_PND_HWEN_COIC_IC_EDCIC_CHRY(PG_AUD_INTRP_CK_PND_HWEN_COIC_IC_EPGAIC_RG_MTKAIF_BYPASS_SRC_MOD_COIC_IC_EVSCA_RG_MTKAIF_SYNC_WORD1),
	_COIC_IC_EINPUIC_RG_AUD_INTRP_CK_PDN_HWEN),
IC_IC_EY(PMG_AUD_INTRP_CK_PDN_HWEN),
	PMLPWRUPG_AUD_INTRP_CK_PDN_HWEN),
	PMLINPUIC_RG_AUD_INTRP_CK_PDN_HWEN),
IC_IC_RENG_UP8X_SYNC_WORD),
	PMI),
IC_IC_RDCC_RG_AUD_INTRP_CK_PND_HWEN_COIC_IC_RDCIC_CHRY(PG_AUD_INTRP_CK_PND_HWEN_COIC_IC_RPGAIC_RG_MTKAIF_BYPASS_SRC_MOD_COIC_IC_RVSCA_RG_MTKAIF_SYNC_WORD1),
	_COIC_IC_RINPUIC_RG_AUD_INTRP_CK_PDN_HWEN),
IC_IC_RY(PMG_AUD_INTRP_CK_PDN_HWEN),
IOIC_EN_RG_AUD_INTRP_CK_PND_HWEN_CO	PMRPWRUPG_AUD_INTRP_CK_PDN_HWEN),
	PMRINPUIC_RG_AUD_INTRP_CK_PDN_HWEN(PMSQYENTTRYG_AUD_INTRP_CK_PDN_HWEN),
ULHALFIC_AUD_TOP_ANA_ID),
	PMIWEN),
GLBNTRLPWENG_AUD_INTRP_CK_PND_HWEN_COIC_IC_EP_RG_AUD_INTRP_CK_PND_HWEN_CO	PM1STSTAGEEP_RG_AUD_INTRP_CK_PND_HWEN_CO	PM2NDSTAGEEP_RG_AUD_INTRP_CK_PND_HWEN_CO	PMFLASHEP_RG_AUD_INTRP_CK_PND_HWEN_COIC_IC_IDDIC_RG_MTKAIF_BYPASS_SRC_MOD_CO	PM1STSTAGEIDDIC_RG_MTKAIF_BYPASS_SRC_MOD_CO	PM2NDSTAGEIDDIC_RG_MTKAIF_BYPASS_SRC_MOD_CO	PMREFBUFIDDIC_RG_MTKAIF_BYPASS_SRC_MOD_CO	PMFLASHIDDIC_RG_MTKAIF_BYPASS_SRC_MOD_CO	PMDAC0P25FAUD_TOP_ANA_ID),
	PMIWEN),
A
	PMIC_RG_AUD_INTRP_CK_PDN_HWEN),
A
	PMICRY(PMG_AUD_INTRP_CK_PND_HWEN_COIC_IC_AAF_RG_AUD_INTRP_CK_PND_HWEN
	PVCMBUFLPIC_C_RG_AUD_INTRP_CK_PDN_HWEN
	PVCMBUFLPSWENG_AUD_INTRP_CK_PND_HWENCMSTBENRG_VSRAM_GPU_RSV_L),
	PMPGABODY_VOW_TGEN_EN),
	PMIC_EMOD_CO	PM1STSTAGES
ENR_AUD_DAC_MONO_SEL),
	OD_CO	PM2NDSTAGEY(PMRG_MTKAIF_BYPASS_SRC_MOD_CO	PM3RDSTAGEY(PMRG_MTKAIF_BYPASS_SRC_MOD_CO	PMFSY(PMRG_MTKAIF_BYPASS_SRC_MOD_CO	PMWIDECRG_VRTC28_BIAS_SEL),
	PM_CO	PMNOPAIC_RG_MTKAIF_BYPASS_SRC_MOD_CO	PMDE2),IW,
 URC_DSN_CGRY(PMIC_T_CO	PMFFDE2),IW,
 URC_DSN_CGRY(PMIC_T_CO	PMDACFBCURRE_SECOND_CNT_START),
	PC_T_CO	PMDACIDDIC_RG_MTKAIF_BYPASS_SRC_MOD_CO	PMDACNRZG_VRTC28_BIAS_SEL),
	PM_CO	PMNODERG_VRTC28_BIAS_SEL),
	PM_CO	PMDACIC_RG_MTKAIF_BYPASS_SRC_MOD_CONTRY(PRG_AUD_INTRP_CK_PDN_HWEN),
NTRY(PRC_RG_AUD_INTRP_CK_PDN_HWEN),
NTRY(PRG_AUDIO_RST),
	PMIC_ENTRY(NTRY(PRC_RG_AUD_INTRP_CK_PDN_HWEN(PMSQYENG_AUD_INTRP_CK_PDN_HWEN(PMSQYPMIC_NMIC_RG_MTKAIF_BYPASS_SRC_MODCMIC_FGENC_RG_AUD_INTRP_CK_PDN_HWEN),
SPA_C_TWO_DIGITAL_MIC_CTLWEN),
ENCSPA_C_TWO_DIGITAL_MIC_CTLWEN),
ENCSPA_CRG_AUD_PAD_TOP_TX_FIFO_RSP)RY(PMIENG_AUD_PAD_TOP_TX_FIFO_RSP)RY(PMIIC_AUD_TOP_ANA_ID),
	PMIWENIC_EHP(PMENG_AUD_PAD_TOP_TX_FIFO_RSP)RY(PMIPDU_RG_DIVCKS_CHG),
	PMIC_ENSP)RY(PMINDU_RG_DIVCKS_CHG),
	PMIC_ENIC_EC_A_RG_AUD_INTRP_CK_PND_HWEN
C_EC_AC_RG_AUD_INTRP_CK_PDN_HWEN),
SPA_CVDN_G_AUD_INTRP_CK_PND_HWEN_COIWDB,IWIC_A0G_AUD_INTRP_CK_PND_HWEN_CO,IWIC_A0DE2),IENG_AUD_PAD_TOP_TX_FIFO_RSP),IWIC_A0LOWP_RG_AUD_INTRP_CK_PND_HWEN_CO,IWIC_A0VC_TIMERINI),
	PMIC_ENTRWEN_CO,IWIC_A0DCSW0P1_RG_AUD_INTRP_CK_PND_HWEN_CO,IWIC_A0DCSW0P2_RG_AUD_INTRP_CK_PND_HWEN_CO,IWIC_A0DCSW0A_RG_AUD_INTRP_CK_PND_HWEN_CO,IWIC_A0DCSW2P1_RG_AUD_INTRP_CK_PND_HWEN_CO,IWIC_A0DCSW2P2_RG_AUD_INTRP_CK_PND_HWEN_CO,IWIC_A0DCSW2A_RG_AUD_INTRP_CK_PND_HWEN_COIWDB,IWIC_A1G_AUD_INTRP_CK_PND_HWEN_CO,IWIC_A1DE2),IENG_AUD_PAD_TOP_TX_FIFO_RSP),IWIC_A1LOWP_RG_AUD_INTRP_CK_PND_HWEN_CO,IWIC_A1VC_TIMERINI),
	PMIC_ENTRWEN_CO,IWIC_A1DCSW1P_RG_AUD_INTRP_CK_PND_HWEN_CO,IWIC_A1DCSW1A_RG_AUD_INTRP_CK_PND_HWENBANDGAPG_RG_AUD_INTRP_CK_PND_HWENM(PMIC_CCI_SPLT_SCRMB_ON),
	WENM(PMICC_RG_AUD_INTRP_CK_PDN_HWENM(PMICCURRE_SECOND_CNT_START),
	PC_T_CO	NTRY(,IWIC_A0PULLLRYG_AUD_INTRP_CK_PDN_HWEN),
	NTRY(,IWIC_A1PULLLRYG_AUD_INTRP_CK_PDN_HWEN),
	NTRY(VIN1PULLLRYG_AUD_INTRP_CK_PDN_HWEN),
	NTRY(VTHAC_RG_VA12_NDIS_EN),
	PMIC_),
	NTRY(VTHBC_RG_VA12_NDIS_EN),
	PMIC_),
	NTRY(TVC_RG_INT_RAW_STATUS_ACCDET	NTRY(C_RG_AUD_INTRP_CK_PDN_HWENSWBUFIC_C_RG_AUD_INTRP_CK_PDN_HWENSWBUFSWENG_AUD_INTRP_CK_PND_HWENMIC_COMPVTHG_AUD_INTRP_CK_PND_HWENMIC_CONFIGPMIC_RG_INT_RAW_STATUS_ACCDETMIC_HIRENR_AUD_DAC_MONO_SEL),
	OD_MIC_R2AUXY(PDE2),IW,
 URC_DSN_CGRY(PMIC_T_MIC_R2AUXBUFFERDE2),IW,
 URC_DSN_CGRY(PMIC_T_MIC_R2AUXSWENG_AUD_INTRP_CK_PND_HWEMIC_ENTRY(PLIC_RGS_AUDRCTUNE1READ),
	PMIC_ENTRY(PRIC_ASYNC_TEST_OUT_BCK),
	P)REC(PMIC_AUDIO_DIG_2ND_DIG_ID),
	REC(PMIC_AUDIO_DIG_2ND_ANA_MINOR_REC(PMICRY(PMIC_AUDIO_DIG_2ND_DIG_MAJOR_REC(PMICRY(PMIC_AUDIO_DIG_2ND_DSN_CBS),
REC(PMICRY(PMIC_AUDIO_DIG_2ND_DIG_MAJOR_REC(_ENTRY(PMIC_AUDIO_DIG_2ND_DSN_CBS),
REC(_PMIC_AUDIO_DIG_2ND_DSN_BIX),
REC(_PMIC_AUDIO_DIG_2ND_ESP),
	PMIREC(_PMIC_AUDIO_DIG_2ND_DSN_FPI),
REC(_PMIC_RG_UP8X_SYNC_WORD),
	PMI),

	NLPWRUPM_ENTP1RG_MTKAIF_TXIF_PROTOCOL2),

	NRPWRUPM_ENTP1RG_MTKAIF_TXIF_PROTOCOL2),

	PMICWR_UPM_E28G_MTKAIF_TXIF_PROTOCOL2),

	PMICWL_UPM_E28G_MTKAIF_TXIF_PROTOCOL2),
HPLPWRUPM_ENTP1RG_MTKAIF_TXIF_PROTOCOL2),
HPRPWRUPM_ENTP1RG_MTKAIF_TXIF_PROTOCOL2),
HPLPWRUPMI(PMIC_ENTP1RG_MTKAIF_TXIF_PROTOCOL2),
HPRPWRUPMI(PMIC_ENTP1RG_MTKAIF_TXIF_PROTOCOL2),
HPLMUXINPUIC_RC_ENTP1RG_MTKAIF_TXIF_PROTOCOL2),
HPRMUXINPUIC_RC_ENTP1RG_MTKAIF_TXIF_PROTOCOL2),
HPLSC(PMIC_CC_ENTP1RG_MTKAIF_TXIF_PROTOCOL2),
HPRSC(PMIC_CC_ENTP1RG_MTKAIF_TXIF_PROTOCOL2),
HPLBSCCURRE_SC_ENTP1RG_MTKAIF_TXIF_PROTOCOL2),
HPRBSCCURRE_SC_ENTP1RG_MTKAIF_TXIF_PROTOCOL2),
HPLOUTPWRUPM_ENTP1RG_MTKAIF_TXIF_PROTOCOL2),
HPROUTPWRUPM_ENTP1RG_MTKAIF_TXIF_PROTOCOL2),
HPLOUTAUXPWRUPM_ENTP1RG_MTKAIF_TXIF_PROTOCOL2),
HPROUTAUXPWRUPM_ENTP1RG_MTKAIF_TXIF_PROTOCOL2HPLAUXFBRSWYENTTENTP1RG_MTKAIF_TXIF_PROTOCOL2HPRAUXFBRSWYENTTENTP1RG_MTKAIF_TXIF_PROTOCOL2HPLSHORT2HPLAUXYENTTENTP1RG_MTKAIF_TXIF_PROTOCOL2HPRSHORT2HPRAUXYENTTENTP1RG_MTKAIF_TXIF_PROTOCOL2HPLOUTSTGCTRRC_ENTP1RG_MTKAIF_TXIF_PROTOCOL2HPROUTSTGCTRRC_ENTP1RG_MTKAIF_TXIF_PROTOCOL2HPLOUTPUTSTBENRC_ENTP1RG_MTKAIF_TXIF_PROTOCOL2HPROUTPUTSTBENRC_ENTP1RG_MTKAIF_TXIF_PROTOCOL2),
HPMIC_VUPM_ENTP1RG_MTKAIF_TXIF_PROTOCOL2),
C_TN_DEY(PYENTTENTP1RG_MTKAIF_TXIF_PROTOCOL2HPPSHORT2VCMITENTP1RG_MTKAIF_TXIF_PROTOCOL2HPINPUICTBENRC_ENTP1RG_MTKAIF_TXIF_PROTOCOL2HPINPUIY(PMR0C_ENTP1RG_MTKAIF_TXIF_PROTOCOL2HPOUTPUTY(PMR0C_ENTP1RG_MTKAIF_TXIF_PROTOCOL2ABIDECMIC_D0C_ENTP28G_MTKAIF_TXIF_PROTOCOL2),
HPDECRY(PMADJC_ENTP1RG_MTKAIF_TXIF_PROTOCOL2),
HPDEDRY(PMADJC_ENTP1RG_MTKAIF_TXIF_PROTOCOL2),
HSPWRUPM_ENTP1RG_MTKAIF_TXIF_PROTOCOL2),
HSPWRUPMI(PMIC_ENTP1RG_MTKAIF_TXIF_PROTOCOL2),
HSMUXINPUIC_RC_ENTP1RG_MTKAIF_TXIF_PROTOCOL2),
HSSC(PMIC_CC_ENTP1RG_MTKAIF_TXIF_PROTOCOL2),
HSBSCCURRE_SC_ENTP1RG_MTKAIF_TXIF_PROTOCOL2),
HSMIC_VUPM_ENTP1RG_MTKAIF_TXIF_PROTOCOL2HSOUTPUTSTBENRC_ENTP1RG_MTKAIF_TXIF_PROTOCOL2HSINPUICTBENRC_ENTP1RG_MTKAIF_TXIF_PROTOCOL2HSINPUIY(PMR0C_ENTP1RG_MTKAIF_TXIF_PROTOCOL2HSOUTPUTY(PMR0C_ENTP1RG_MTKAIF_TXIF_PROTOCOL2HSOUT_SHORTVCMITENTP1RG_MTKAIF_TXIF_PROTOCOL2ENTLOLPWRUPM_ENTP1RG_MTKAIF_TXIF_PROTOCOL2),
LOLPWRUPMI(PMIC_ENTP1RG_MTKAIF_TXIF_PROTOCOL2),
LOLMUXINPUIC_RC_ENTP1RG_MTKAIF_TXIF_PROTOCOL2),
LOLSC(PMIC_CC_ENTP1RG_MTKAIF_TXIF_PROTOCOL2),
LOLBSCCURRE_SC_ENTP1RG_MTKAIF_TXIF_PROTOCOL2),
LOMIC_VUPM_ENTP1RG_MTKAIF_TXIF_PROTOCOL2LOINPUICTBENRC_ENTP1RG_MTKAIF_TXIF_PROTOCOL2LOOUTPUTSTBENRC_ENTP1RG_MTKAIF_TXIF_PROTOCOL2LOINPUIY(PMR0C_ENTP1RG_MTKAIF_TXIF_PROTOCOL2LOOUTPUTY(PMR0C_ENTP1RG_MTKAIF_TXIF_PROTOCOL2LOOUT_SHORTVCMITENTP1RG_MTKAIF_TXIF_PROTOCOL2ENTRY(PBUF_INPUIMUXC_RC_ENTP1RG_MTKAIF_TXIF_PROTOCOL2),
RY(PBUF_Y(PMC_RC_ENTP1RG_MTKAIF_TXIF_PROTOCOL2),
RY(PBUF_ENTTENTP1RG_MTKAIF_TXIF_PROTOCOL2),
HPMPK(PMIINPUIMUXC_RC_ENTP1RG_MTKAIF_TXIF_PROTOCOL2),
HPMPK(PMIOUTPUTMUXC_RC_ENTP1RG_MTKAIF_TXIF_PROTOCOL2),
HPMPK(PMIENTTENTP1RG_MTKAIF_TXIF_PROTOCOL2)BIDECMIC_D0C_E28G_MTKAIF_TXIF_PROTOCOL2)BIDECMIC_D0C_ENTP1RG_MTKAIF_TXIF_PROTOCOL2)BIDECMIC_D1C_ENTP1RG_MTKAIF_TXIF_PROTOCOL2)BIDECMIC_D2C_ENTP1RG_MTKAIF_TXIF_PROTOCOL2),
ZCDMUXC_RC_ENTP1RG_MTKAIF_TXIF_PROTOCOL2),
ZCDPMIC_RC_ENTP1RG_MTKAIF_TXIF_PROTOCOL2),
(PMIADJC0C_ENTP1RG_MTKAIF_TXIF_PROTOCOL2),
(PMIADJC1C_ENTP1RG_MTKAIF_TXIF_PROTOCOL2)UDI(PMIIC_DNT_ENTP1RG_MTKAIF_TXIF_PROTOCOL2Y(PMIDECODEYC_E28G_MTKAIF_TXIF_PROTOCOL2C_RCDECODEYC96KC_E28G_MTKAIF_TXIF_PROTOCOL2C_RCDELAY_VCO_C_TWO_DIGITAL_MIC_CTLWEN),
GLBMIC_DNT_E28G_MTKAIF_TXIF_PROTOCOL2Y(PMIENCODEYC_E28G_MTKAIF_TXIF_PROTOCOL2C_RCENCODEYC96KC_E28G_MTKAIF_TXIF_PROTOCOL2HCMIC_ENTTE18G_MTKAIF_TXIF_PROTOCOL2HCMIC_PDPMIC_RTTE18G_MTKAIF_TXIF_PROTOCOL2HCMIC_REMOMIC_ENC_TTE18G_MTKAIF_TXIF_PROTOCOL2LCMIC_ENTTE18G_MTKAIF_TXIF_PROTOCOL2LCMIC_PDPMIC_RTTE18G_MTKAIF_TXIF_PROTOCOL2LCMIC_REMOMIC_ENC_TTE18G_MTKAIF_TXIF_PROTOCOL2LCMIC_ENCC_RTTE28G_MTKAIF_TXIF_PROTOCOL2LCMIC_ENCCPDPMIC_RTTE28G_MTKAIF_TXIF_PROTOCOL2LCMIC_ENCCREMOMIC_ENC_TTE28G_MTKAIF_TXIF_PROTOCOL2VA33C_FGENC_RTTE18G_MTKAIF_TXIF_PROTOCOL2TE28C_FGENC_RTTE28G_MTKAIF_TXIF_PROTOCOL2HCMIC_MIC_RTTE18G_MTKAIF_TXIF_PROTOCOL2LCMIC_MIC_RTTE18G_MTKAIF_TXIF_PROTOCOL2NVREGIENTTENTP1RG_MTKAIF_TXIF_PROTOCOL2NVREGIPULL0VC_ENTP1RG_MTKAIF_TXIF_PROTOCOL2)UDPM(PMID0C_ENTP1RG_MTKAIF_TXIF_PROTOCOL2)UDPM(PMID0C_E18G_MTKAIF_TXIF_PROTOCOL2)UDPM(PMID0C_E28G_MTKAIF_TXIF_PROTOC),
REC((PMIC_RG_ISINK_TRIM_BIAS),
	PM),
HPLRY(PM_ENTP1RG_MTKAIF_TXIF_PROTOCOL2),
HPRRY(PM_ENTP1RG_MTKAIF_TXIF_PROTOCOL2),
HPLFINERY(PM_ENTP1RG_MTKAIF_TXIF_PROTOCOL2),
HPRFINERY(PM_ENTP1RG_MTKAIF_TXIF_PROTOCOL2),
HP(PMIC_RM_ENTP1RG_MTKAIF_TXIF_PROTOC),
ZCD(PMIC_AUDIO_DIG_2ND_DIG_ID),
	ZCD(PMIC_AUDIO_DIG_2ND_ANA_MINOR_ZCD(PMICRY(PMIC_AUDIO_DIG_2ND_DIG_MAJOR_ZCD(PMICRY(PMIC_AUDIO_DIG_2ND_DSN_CBS),
ZCD(PMICRY(PMIC_AUDIO_DIG_2ND_DIG_MAJOR_ZCD(_ENTRY(PMIC_AUDIO_DIG_2ND_DSN_CBS),
ZCD(_PMIC_AUDIO_DIG_2ND_DSN_BIX),
ZCD(_PMIC_AUDIO_DIG_2ND_ESP),
	PMIZCD(_PMIC_AUDIO_DIG_2ND_DSN_FPI),
ZCD(_PMIC_RG_UP8X_SYNC_WORD),
	PMI),
ZCDPMIC_CCI_AUDIO_FIFO_CLKIN_PMI),
ZCDY(PMCTEPY(PMCI_AUDIO_FIFO_CLKIN_PMI),
ZCDY(PMCTEPY(PMCI_AUDIO_FIFO_CLKIN_PMI),
ZCDY(PMOUTIC_TC_RG_AUD_INTRP_CK_PDN_HWEN),
LOLY(PMG_AUD_INTRP_CK_PDN_HWEN),
LORY(PMG_AUD_INTRP_CK_PDN_HWEN),
H_EY(PMG_AUD_INTRP_CK_PDN_HWEN),
H_RY(PMG_AUD_INTRP_CK_PDN_HWEN),
HSY(PMG_AUD_INTRP_CK_PDN_HWEN),
IVEY(PMG_AUD_INTRP_CK_PDN_HWEN),
IVRY(PMG_AUD_INTRP_CK_PDN_HWEN),
INTY(PM1G_AUD_INTRP_CK_PND_HWEN_COINTY(PMRG_AUD_PAD_TOP_TX_FIFENTRY(PPMIC_AUDIO_DIG_2ND_DIG_ID),NTRY(PPMIC_AUDIO_DIG_2ND_ANA_MINONTRY(PPMICRY(PMIC_AUDIO_DIG_2ND_DIG_MAJONTRY(PPMICRY(PMIC_AUDIO_DIG_2ND_DSN_CBS)NTRY(PPMICRY(PMIC_AUDIO_DIG_2ND_DIG_MAJONTRY(P_ENTRY(PMIC_AUDIO_DIG_2ND_DSN_CBS)NTRY(P_PMIC_AUDIO_DIG_2ND_DSN_BIX)NTRY(P_PMIC_AUDIO_DIG_2ND_ESP),
	PNTRY(PM_AUDIO_DIG_2ND_DSN_FPI)NTRY(P_PMIC_AUD_TOP_CLK_OFFSET),
	PM)NTRY(AUXADCSWCTRRUD_TOP_CLK_OFFSET),
	PM)NTRY(AUXADCSWCTRRIC_RG_AUD_PAD_TOP_PHASE_MODE),)NTRY(C_RG_ISINK0_CHOP_EN),
	PNTRY(PMAUDIO_DIG_2ND_ANA_ID),NTRY(PMEQYPM_RG_AMIC_UL_ADC_CLK_SEENTRY(PMIC_RPMAUDIO_DIG_2ND_ANA_ID),NTRY(PMIC_RPMEQYPM_RG_AMIC_UL_ADC_CLK_SEENTRY(PMIC_IC_ISINK_CHOP0_EN),
	PMIENTRY(PMIC_ICMEQYPM_RG_AMIC_UL_ADC_CLK_SEENTRY(PPMISWCTRRIC_RG_AUD_PAD_TOP_PHASE__ENTRY(PMPMICIC_RG_ISINK_TRIM_SEL),
	_ENTRY(VTHMICIC_RG_ISINK_TRIM_SEL),
	_ENTRY(M(PMICICIC_RG_ISINK_TRIM_SEL),
	_ENTRY(MIC_RPICIC_RG_ISINK_TRIM_SEL),
	_ENTRY(MIC_1PICIC_RG_ISINK_TRIM_SEL),
	_ENTRY(PMPMICICID_MTKAIF_RXIF_INVALID_F)ENTRY(VTHMICICID_MTKAIF_RXIF_INVALID_F)ENTRY(M(PMICICICID_MTKAIF_RXIF_INVALID_F)ENTRY(MIC_RPICICID_MTKAIF_RXIF_INVALID_F)ENTRY(MIC_1PICICID_MTKAIF_RXIF_INVALID_F)ENTRY(ICICWIDTHG_AUD_INTRP_CK_PND_H)ENTRY(ICICTHY(PHG_AUD_INTRP_CK_PND_H)ENTRY(IC_KCDELAYG_AUD_INTRP_CK_PND_H)ENTRY(IC_KCDELAYG_AUD_INTRP_CK_PND_H)ENTRY(DEBOUNCE0G_AUD_INTRP_CK_PND_H)ENTRY(DEBOUNCE1G_AUD_INTRP_CK_PND_H)ENTRY(DEBOUNCERG_AUD_PAD_TOP_TX_FIFENTRY(PDEBOUNCE3G_AUD_PAD_TOP_TX_FIFENTRY(PDEBOUNCE4G_AUD_PAD_TOP_TX_FIFENTRY(PIVALCCURC_MTKAIF_TXIF_IN_CH1),
)ENTRY(MIC_RPIVALCCURC_MTKAIF_TXIF_IN_CH1),
)ENTRY(MIC_1PIVALCCURC_MTKAIF_TXIF_IN_CH1),
)ENTRY(IVALCSAMC_MTKAIF_TXIF_IN_CH1),
)ENTRY(MIC_RPIVALCSAMC_MTKAIF_TXIF_IN_CH1),
)ENTRY(MIC_1PIVALCSAMC_MTKAIF_TXIF_IN_CH1),
)ENTRY(IVALCMEMC_MTKAIF_TXIF_IN_CH1),
)ENTRY(MIC_RPIVALCMEMC_MTKAIF_TXIF_IN_CH1),
)ENTRY(MIC_1PIVALCMEMC_MTKAIF_TXIF_IN_CH1),
)ENTRY(IVALCS_RG_AUD_PAD_TOP_PHASE__ENTRY(MIC_RPIVALCS_RG_AUD_PAD_TOP_PHASE__ENTRY(MIC_1PIVALCS_RG_AUD_PAD_TOP_PHASE__ENTRY(IRQG_AUD_PAD_TOP_PHASE__ENTRY(MIC_RPIRQG_AUD_PAD_TOP_PHASE__ENTRY(MIC_1PIRQG_AUD_PAD_TOP_PHASE__ENTRY(IRQ_C_RG_INT_STATUS_AUDIO),_ENTRY(MIC_RPIRQ_C_RG_INT_STATUS_AUDIO),_ENTRY(MIC_1(IRQ_C_RG_INT_STATUS_AUDIO),_ENTRY(MIC_RPIRQ_Y(PMIC_RG_DIVCKS_CHG),
	PMIC_ENTRY(MIC_1(IRQ_Y(PMIC_RG_DIVCKS_CHG),
	PMIC_ENTRY((PMICIC_T0G_AUD_INTRP_CK_PND_H)ENTRY(PMPMSWS_RG_AUD_PAD_TOP_PHASE__ENTRY(VTHMSWS_RG_AUD_PAD_TOP_PHASE__ENTRY(M(PMICSWS_RG_AUD_PAD_TOP_PHASE__ENTRY((PMICIC_T4G_AUD_PAD_TOP_TX_FIFENTRY(P(PMICIC_TRG_MTKAIF_TXIF_PROTOC)ENTRY(ICICS_RG_AUD_PAD_TOP_PHASE__ENTRY(INC_VOW_TGEN_EN),
	PMIC_E)ENTRY(PMPMENC_VOW_TGEN_EN),
	PMIC_E)ENTRY(VTHMENC_VOW_TGEN_EN),
	PMIC_E)ENTRY(M(PMIC_DC_VOW_TGEN_EN),
	PMIC_E)ENTRY(ICIC_RC_VOW_TGEN_EN),
	PMIC_E)ENTRY(_MTKAIF_TXIF_IN_CH1),
)ENTRY(CURC_MTKAIF_TXIF_IN_CH1),
)ENTRY(SAMC_MTKAIF_TXIF_IN_CH1),
)ENTRY(MEMC_MTKAIF_TXIF_IN_CH1),
)ENTRY(PMICMTKAIF_RXIF_INVALID_F)ENTRY(M(PMICCLM8_HW0_OP_BW DE2),IW,)ENTRY(VTHMCLM8_HW0_OP_BW DE2),IW,)ENTRY(PMPMCLM8_HW0_OP_BW DE2),IW,
	PMIC)NTRY(AUXADCSWCTRRUD_TOP_CLK_OFFSET),
	ENTRY(MIC_RPDEBCS_RG_AUD_PAD_TOP_PHASE__ENTRY(MIC_RPDEBOUNCETKAIF_RXIF_INVALID_F)ENTRY(MIC_RPICICTHY(PHG_AUD_INTRP_CK_PND_H)ENTRY(MIC_RPICICWIDTHG_AUD_INTRP_CK_PND_H)ENTRY(MIC_RPICICIC_KCDELAYG_AUD_INTRP_CK_PND_H)ENTRY(MIC_RPICICIC_KCDELAYG_AUD_INTRP_CK_PND_H)ENTRY((PMICIC_T11G_AUD_INTRP_CK_PND_H)ENTRY((PMICIC_T10G_AUD_INTRP_CK_PND_H)ENTRY(MIC_RPPMPOUT_SVOW_TGEN_EN),
	PMIC_E)ENTRY(MIC_1(PMPOUT_SVOW_TGEN_EN),
	PMIC_E)ENTRY((PMICIC_T9OW_TGEN_EN),
	PMIC_E)ENTRY((PMICIC_T8G_MTKAIF_TXIF_PROTOC)NTRY(PPUXADC_CTRRICVOW_TGEN_EN),
	PMIC_E)ENTRY((PMICIC_T7OW_TGEN_EN),
	PMIC_E)ENTRY((PMICIC_T6G_AUD_INTRP_CK_PND_H)ENTRY(MIC_RPPMPC_RC_VOW_TGEN_EN),
	PMIC_E)ENTRY(MIC_1(PMPC_RC_VOW_TGEN_EN),
	PMIC_E)ENTRY(MIC_0(PMICMTKAIF_RXIF_INVALID_F)ENTRY(PUXADC_DEBOUNCEIF_AUDIO_DIG_2ND_ANA_MINONTRY(PPUXADC_CONNMIC_C_C_TWO_DIGITAL_MIC_CTL)ENTRY(MIC_RPPURC_MTKAIF_TXIF_IN_CH1),
)ENTRY(MIC_RPSAMC_MTKAIF_TXIF_IN_CH1),
)ENTRY(MIC_RPMEMC_MTKAIF_TXIF_IN_CH1),
)D(MIC_RPMPOUT8_HW0_OP_BW DE2),IW,
	PNI(MIC_RPMP_RG_ISINK_TRIM_SEL),
	_ENTRY(PURCDEB_TWO_DIGITAL_MIC_CTL)ENTRY(MIC_RPPURCDEB_TWO_DIGITAL_MIC_CTL)ENTRY(NTRY(PMIC_AUDIO_DIG_ANA_ID),
	PMENTRY(NTRY(PMICS_RG_AUD_PAD_TOP_PHASE__ENTRY(MIC_CC_NLE_LCH_ON),
	PMIC_ENONTRY(PPUXADC_CONNMIC_Y(PMCI_AUDIO_FIFO_CLKIN_ONTRY(P_ENTRS_RG_AUD_PAD_TOP_PHASE__ENTRY(HWY(PMIC_VOW_INTR_SW_VAL),
	PM)ENTRY(MIC_PDEBCOUT_DFTIMERINI),
	PMIC_ENTR)ENTRY(ICPMIC_RCHRY(PG_AUD_INTRP_CK_PND_H)ENTRY(MIC_RPRENER_K_GAMMA),
	PMIC_ENTRY)ENTRY(MIC_1(RENER_K_GAMMA),
	PMIC_ENTRY)ENTRY(MIC_1(DEBCS_RG_AUD_PAD_TOP_PHASE__ENTRY(MIC_1PDEBOUNCETKAIF_RXIF_INVALID_F)ENTRY(MIC_1PICICTHY(PHG_AUD_INTRP_CK_PND_H)ENTRY(MIC_1PICICWIDTHG_AUD_INTRP_CK_PND_H)ENTRY(MIC_1PICICIC_KCDELAYG_AUD_INTRP_CK_PND_H)ENTRY(MIC_1PICICIC_KCDELAYG_AUD_INTRP_CK_PND_H)ENTRY(MIC_ICMMICMTKAIF_RXIF_INVALID_F)ENTRY(MIC_1(PURC_MTKAIF_TXIF_IN_CH1),
)ENTRY(MIC_1PSAMC_MTKAIF_TXIF_IN_CH1),
)ENTRY(MIC_1PMEMC_MTKAIF_TXIF_IN_CH1),
)D(MIC_1PMPOUT8_HW0_OP_BW DE2),IW,
	PNI(MIC_1PMP_RG_ISINK_TRIM_SEL),
	_ENTRY